...
public class FragSent extends Fragment {
    ...
    private void Controls()
    {
        ...
        {
            getInvtItem = databaseAccess.getMatInvSent(cst);
        }
        else if ( act.equals("Delivery"))
        {
            getInvtItem = databaseAccess.getMatDelSent(cst);
        }
        else if (act.equals("ABIS"))
        {
            getInvtItem = databaseAccess.getMatAbisSent(cst);
        }
